...
let name1: string = "Ahmad";
let name2: string = "Abu-Hurairah";
let name3: string = "Naveed";
...
let names1: string[] = ["Alam", "Sheraz", "ahmad", "abdullah"];
//                          0       1       2           3
...
const data = (index: number): number => index;
...
let lastIndex: number = names1.length; // we use length property to get the lenght of array
...
console.log(
  `pop return the element that get deleted which is '${deleting}'\nso the array will look like:-`
);
...
console.log(
  `unshift also return thelenth of the new array which is '${adding1}'`
);
...
console.log(
  `shift return the element that get deleted which is '${deleting1}'\nso the array will look like:-`
);
