...
let monthName: string = "january";
switch (monthName) {
  case "january":
    console.log(
      `The month number of month '${monthName}' is 1 and there are 31 days in it.`
    );

    break;
  case "febraury":
    console.log(
      `The month number of month '${monthName}' is 2 and there are 28 days in it.`
    );

    break;
  case "march":
    console.log(
      `The month number of month '${monthName}' is 3 and there are 31 days in it.`
    );

    break;
  case "april":
    console.log(
      `The month number of month '${monthName}' is 4 and there are 30 days in it.`
    );

    break;
  case "may":
    console.log(
      ` The month number of month '${monthName}' is 5 and there are 31 days in it.`
    );

    break;
  case "june":
    console.log(
      `The month number of month '${monthName}' is 6 and there are 30 days in it.`
    );

    break;
  case "july":
    console.log(
      `The month number of month '${monthName}' is 7 and there are 31 days in it.`
    );

    break;
  case "august":
    console.log(
      ` The month number of month '${monthName}' is 8 and there are 31 days in it.`
    );

    break;
  case "september":
    console.log(
      `The month number of month '${monthName}' is 9 and there are 30 days in it.`
    );

    break;
  case "october":
    console.log(
      ` The month number of month '${monthName}' is 10 and there are 31 days in it.`
    );

    break;
  case "november":
    console.log(
      `The month number of month '${monthName}' is 11 and there are 30 days in it.`
    );

    break;
  case "december":
    console.log(
      `The month number of month '${monthName}' is 12 and there are 31 days in it.`
    );
...
let monthName1: string = "febraury";
...
function minus(num1: number, num2: number) {
  console.log(
    `when we minus ${num1} from ${num2} the result is ${num2 - num1}`
  );
}
...
function classifyNumber(num: number) {
  if (num > 0) {
