...
class App {
    taskList; // Define taskList as a property of the class to hold Todos
    starredTodos; // Define starredTodos as a property of the class to hold Todos
    completedTodos; // Define completedTodos as a property of the class to hold Todos
    constructor() {
    ...
    async start() {
        while (true) {
            console.log("=================== Welcome to todo management System! =================");
            ...
            switch (userChoice) {
                case "Add a new todo":
                    ...
                    let task = inputTask.task;
                    let description = inputTask.description;
                ...
                case "Edit a todo":
                    ...
                    const userUpdateChoice = updateChoice.updateChoice;
                    switch (userUpdateChoice) {
                        ...
                        case "Update both task and description":
                            ...
                            this.editTaskAndDescription(updatedTask.task, updatedDescription.description, editTodoId);
                            break;
                        default:
                ...
                case "Complete a todo":
                    ...
                    const completedTodoId = completedTodo.id;
                ...
                case "Uncomplete a todo":
                    ...
                    const unCompletedTodoId = unCompletedTodo.id;
                ...
                case "Star a todo":
                    ...
                    const starredTodoId = starredTodo.id;
                    this.starTodo(starredTodoId);
                    break;
                case "Unstar a todo":
                    console.log("Enter the id of the todo you want to mark as unStarred:");
                    const unStarredTodo = await inquirer.prompt([
                        {
                            type: "number",
                            name: "id",
                            message: "Enter the id of the todo you want to mark as unStarred:",
                        },
                    ]);
                    const unStarredTodoId = unStarredTodo.id;
                ...
                case "Search a todo":
                    ...
                    const keyword = keywordSearch.keyword;
    ...
    addTodo(task, description) {
        ...
        console.log(`The todo added successfully with the id: ${this.taskList.length} `);
    }
    viewTask() {
    ...
    editTask(task, id) {
        ...
        if (!isNaN(id)) {
            ...
            console.log(`There is an error occuring while updating the task of todo! `);
        }
    }
    editDescription(description, id) {
        ...
        if (!isNaN(id)) {
            ...
            console.log(`The todo with the id: ${id}'s description is edited successfully `);
        }
        else {
            console.log(`There is an error occuring while updating the description of todo! `);
        }
    }
    editTaskAndDescription(task, description, id) {
        // Edit a task in the taskList
        if (!isNaN(id)) {
            this.taskList = this.taskList.map((todo) => {
                if (todo.id === id) {
    ...
    searchTodo(keywordSearch) {
        const keyword = keywordSearch.toLowerCase();
        const foundByKeyword = this.taskList.filter((todo) => todo.task.toLowerCase().includes(keyword) ||
    ...
    uncompleteTodo(id) {
        if (!isNaN(id)) {
            ...
            console.log(`The todo with the id: ${id} marked Uncompleted successfully `);
        }
    }
    // Star a todo
    starTodo(id) {
